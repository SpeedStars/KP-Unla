            ...
            <div class="col-md-6">
                <div class="row mb-5">
                    <div class="col-md-6 mb-3 mb-md-0">
                        ...
                        @else
                            <button type="submit" class="btn btn-primary btn-sm btn-block" onclick="return false">Update Keranjang</button>
                        @endif
                    </div>   
                </div>
            </div>
                ...
                <div class="row justify-content-end">
                    <div class="col-md-7">
                        ...
                        <div class="row">
                            ...
                            @else
                                <div class="col-md-12">
                                    <a href="{{ route('user.checkout') }}" class="btn btn-primary btn-lg py-3 btn-block" onclick="return false">Checkout</a>
                                    <small>Tidak Ada Data Produk Di Keranjang Belanja, Silahkan Tambahkan Produk Ke Keranjang Terlebih Dahulu</small>
                                </div>
                            @endif
